...
namespace BorinagaEvedri
{
    public partial class Dashboard: Form
    {
        ...
        public Dashboard(ILogger<Signin> logger, string fullName, string gender, string imagePath)
        {
            ...
            OpenChildForm(new BorinagaEvedri.DbStatus(_logger), null);
        }
        ...
        {
            OpenChildForm(new BorinagaEvedri.DbStatus(_logger), sender);
        }

        private void guna2btnIAS_Click(object sender, EventArgs e)
        {
            OpenChildForm(new BorinagaEvedri.Inactive_Students(), sender);
        }

        private void guna2Logs_Click(object sender, EventArgs e)
        {
            OpenChildForm(new BorinagaEvedri.Logs(), sender);
        }
        ...
        private void guna2BtnAddUser_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            f1.Show();
            _logger.LogInformation("User navigated to Add User form.");
        }
    }
}
