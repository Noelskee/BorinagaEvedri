...
namespace BorinagaEvedri
{
    public partial class Logs : Form
    {
        ...
        private void LoadLogs()
        {
            ...
            dataGridView3.Refresh(); // Refresh the DataGridView
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView3.SelectedRows.Count > 0)
            {
                ...
                // Check if the selected row is the new row
                if (selectedRow.Index == dataGridView3.NewRowIndex)
                {
                    MessageBox.Show("Cannot delete a new row. Please commit your changes first.", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                ...
                if (MessageBox.Show("Are you sure you want to delete this log?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                {
                    ...
                    using (Workbook book = new Workbook())
                    {
                        ...
                        int excelRowIndex = selectedRow.Index + 2; // Adjusting for the header row
